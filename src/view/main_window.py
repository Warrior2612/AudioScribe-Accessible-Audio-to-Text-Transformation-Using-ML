...
class MainWindow(ctk.CTkFrame):
    ...
    def _init_sidebar(self):
        ...
        self.lbl_whisper_options.grid(row=0, column=0, padx=10, pady=(5, 7.5))
        ...
        self.chk_whisper_options_subtitles.grid(
            row=2, column=0, padx=20, pady=(5, 0), sticky=ctk.W
        )
        ...
        self.lbl_appearance_mode.grid(row=12, column=0, padx=20, pady=(20, 0))
    ...
    def _start_recording_from_mic(self):
        ...
        self._controller.prepare_for_transcription(
            ...
            transcription_method=TranscriptionMethod.WHISPERX.value,
